...
<body>
			...
			<div class="row">
				...
				<div class="col-4">
					<div class="row">
						...
						<div class="col-3">
							<a href="admin2.php"><img src="update.png" class="w-50"></a>
						</div>
	...
	<form action="update.php" method="GET" style=" background-color: #f7f7f7" class="border col-8 mx-auto mt-5 py-4"  >
		<h4 class="text-center ml-3">Изменить публикацию</h4>
		<div class="mt-2 col-12">
			<input type="" name="id" class="col-12" placeholder="ID" style="height: 100px">
		</div>
		<div class="mt-2 col-12">
			<input type="" name="img" class="col-12" placeholder="IMG" style="height: 100px">
		</div>
		<div class="mt-2 col-12">
			<input type="" name="texts" class="col-12" placeholder="TEXTS" style="height: 100px">
		</div>
		
		<div class="mx-auto col-1 mt-4">
			<button class="rounded bg-dark text-center text-white"> изменить</button>
		</div>
